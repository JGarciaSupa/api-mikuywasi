...
export const getAllPlansController = async (c: Context) => {
  try {
    ...
    return c.json({ success: true, message: 'Planes obtenidos con éxito', data: result });
  } catch (error: any) {
    return c.json({ success: false, message: error.message || 'Error al obtener planes', data: null }, 500);
  }
};
...
export const getPlanByIdController = async (c: Context) => {
  try {
    ...
    return c.json({ success: true, message: 'Plan obtenido con éxito', data: result });
  } catch (error: any) {
    return c.json({ success: false, message: error.message || 'Plan no encontrado', data: null }, 404);
  }
};
...
export const createPlanController = async (c: Context) => {
  try {
    ...
    return c.json({ success: false, message: error.message || 'Error al crear el plan', data: null }, 400);
  }
};
...
export const updatePlanController = async (c: Context) => {
  try {
    ...
    return c.json({ success: false, message: error.message || 'Error al actualizar el plan', data: null }, 400);
  }
};
...
export const deletePlanController = async (c: Context) => {
  try {
    ...
    return c.json({ success: true, message: result.message || 'Plan eliminado correctamente', data: null });
  } catch (error: any) {
    return c.json({ success: false, message: error.message || 'Error al eliminar el plan', data: null }, 400);
  }
};
